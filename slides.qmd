...
* __Favorite Course to Teach__: <mark>Foundations of Data Science</mark>.
:::
...
library(tidyverse)
responses_wide <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1LlhZUYgl0i44vkh6LGH0wfrkoTY5GbTnYF4QeYm3mFY/edit?resourcekey=&gid=1552491828#gid=1552491828") ##|> slice(-2) first row is our course, second row is fake
...
responses_sum <- responses_long |> group_by(topic_short) |>
  ...
  ## maybe add a filter here to keep only the top responses
  ## mention verbally which topics were chosen less often

ggplot(data = responses_sum, aes(x = n, y = topic_short)) +
